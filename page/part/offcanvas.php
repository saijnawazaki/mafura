...
<div role="alert" id="offcanvas_open_panel" class="position-fixed top-0 left-0 width-fluid height-vh hide">
  <div class="position-relative width-fluid height-vh">
    ...
    <div class="bg-light bc-muted color-dark br-t-r-2 br-b-r-2 p-3 position-absolute left-0 top-0 height-vh width-s-panel">
      ...
      <div class="text-right">
        <a href="javascript:void(0)" class="mr-2" data-toggle="hide" aria-controls="offcanvas_open_panel">
          OK
        </a>
...
<div role="alert" id="offcanvas_right_open_panel" class="position-fixed top-0 left-0 width-fluid height-vh hide">
  <div class="position-relative width-fluid height-vh">
    ...
    <div class="bg-light bc-muted color-dark br-t-l-2 br-b-l-2 p-3 position-absolute right-0 top-0 height-vh width-s-panel">
      <div class="d-flex justify-content-between">
        <h1>Header</h1>
      ...
      <p>Content Here</p>
      <div class="text-right">
        <a href="javascript:void(0)" class="mr-2" data-toggle="hide" aria-controls="offcanvas_right_open_panel">
          OK
        </a>
